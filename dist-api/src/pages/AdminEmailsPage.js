            ...
            <div className="lg:col-span-1">
              ...
              <div className="space-y-4">
                ...
                <div className="border border-gray-200 rounded-lg p-4">
                  ...
                  <Button onClick={() => previewTemplate('welcome')} variant="secondary" className="w-full">
                    Visualizar Template
                  </Button>
                </div>
                ...
                <div className="border border-gray-200 rounded-lg p-4">
                  ...
                  <Button onClick={() => previewTemplate('parceira')} variant="secondary" className="w-full">
                    Visualizar Template
                  </Button>
                </div>
              ...
              <div className="mt-6">
                ...
                <div className="space-y-3 text-sm">
                  <div>
                    ...
                    <input type="text" className="w-full p-2 border border-gray-300 rounded" placeholder="Maria Silva" value={previewData.userName || ''} onChange={(e) => setPreviewData({ ...previewData, userName: e.target.value })}/>
                  </div>
                  <div>
                    <label className="block text-gray-600">Email da Usuária</label>
                    <input type="email" className="w-full p-2 border border-gray-300 rounded" placeholder="maria@exemplo.com" value={previewData.userEmail || ''} onChange={(e) => setPreviewData({ ...previewData, userEmail: e.target.value })}/>
                  </div>
                  <div>
                    <label className="block text-gray-600">Código do Cupom</label>
                    <input type="text" className="w-full p-2 border border-gray-300 rounded" placeholder="LANA20" value={previewData.cupomCode || ''} onChange={(e) => setPreviewData({ ...previewData, cupomCode: e.target.value })}/>
                  </div>
                  <div>
                    <label className="block text-gray-600">Nome da Parceira</label>
                    <input type="text" className="w-full p-2 border border-gray-300 rounded" placeholder="Lana Santos" value={previewData.parceiraName || ''} onChange={(e) => setPreviewData({ ...previewData, parceiraName: e.target.value })}/>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-2">
              ...
              {!showPreview ? (<div className="text-center py-12 text-gray-500">
                  ...
                  <div className="border border-gray-200 rounded-lg p-4">
                    ...
                    <div className="mt-2">
                      <Button onClick={() => copyToClipboard(template.subject)} variant="secondary" className="text-xs">
                        Copiar Assunto
                      </Button>
                    </div>
                  </div>
                  ...
                  <div className="border border-gray-200 rounded-lg p-4">
                    ...
                    <div className="bg-gray-50 p-3 rounded border max-h-80 overflow-auto">
                      <iframe srcDoc={template.htmlContent} className="w-full h-96 border-0" title="Preview Email"/>
                    </div>
                    <div className="mt-2 flex gap-2">
                      <Button onClick={() => copyToClipboard(template.htmlContent)} variant="secondary" className="text-xs">
                        Copiar HTML
                      </Button>
                      <Button onClick={() => downloadTemplate(template.htmlContent, `${activeTemplate}-template.html`)} variant="secondary" className="text-xs">
                        Download HTML
                      </Button>
                    </div>
                  </div>
                  ...
                  <div className="border border-gray-200 rounded-lg p-4">
                    ...
                    <div className="mt-2">
                      <Button onClick={() => copyToClipboard(template.textContent)} variant="secondary" className="text-xs">
                        Copiar Texto
                      </Button>
                    </div>
                  </div>
