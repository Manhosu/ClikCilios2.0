...
const ConfiguracoesPage = () => {
    ...
    return (<div className="min-h-screen bg-gradient-to-br from-rose-50 via-white to-purple-50 transition-colors duration-200">
        ...
        <div className="space-y-6">
          ...
          <div className="card-elegant p-8">
              ...
              <div className="bg-gradient-to-r from-primary-50 to-secondary-50 p-6 rounded-2xl">
                <div className="flex items-center justify-between">
                  ...
                  <label className="relative inline-flex items-center cursor-pointer ml-6">
                    <input type="checkbox" checked={configuracoes.backup_automatico} onChange={(e) => setConfiguracoes(prev => ({
            ...prev,
            ...
            <div className="flex justify-end mt-8">
              <Button onClick={salvarConfiguracoes} variant="primary" isLoading={salvando} className="shadow-elegant hover:scale-105 transition-transform">
                💾 Salvar Preferências
              </Button>
            </div>
          </div>
          ...
          <div className="card-elegant p-8">
            <div className="flex items-center justify-between mb-6">
              ...
              {!editandoPerfil && (<Button onClick={() => setEditandoPerfil(true)} variant="secondary" className="hover:scale-105 transition-transform">
                  ✏️ Editar
                </Button>)}
            </div>
            
            {editandoPerfil ? (<div className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">
                      ✨ Nome *
                    </label>
                    <input type="text" value={dadosPerfil.nome} onChange={(e) => setDadosPerfil(prev => ({ ...prev, nome: e.target.value }))} className="w-full p-4 border border-gray-200 rounded-2xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-all" placeholder="Seu nome completo" required/>
                  </div>
                  ...
                  <div>
                    ...
                    <input type="email" value={dadosPerfil.email} onChange={(e) => setDadosPerfil(prev => ({ ...prev, email: e.target.value }))} className="w-full p-4 border border-gray-200 rounded-2xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-all" placeholder="seu@email.com" required/>
                  </div>
                </div>
                ...
                <div className="flex gap-4 pt-4">
                  <Button onClick={cancelarEdicao} variant="secondary" className="flex-1">
                    Cancelar
                  </Button>
                  <Button onClick={salvarPerfil} variant="primary" isLoading={salvandoPerfil} className="flex-1 shadow-elegant hover:scale-105 transition-transform">
                    💾 Salvar Alterações
                  </Button>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-4">
                <div className="p-6 bg-gradient-to-r from-orange-50 to-orange-100 rounded-2xl border border-orange-200">
                  ...
                  <Button onClick={handleLogout} variant="secondary" className="w-full border-orange-300 text-orange-700 hover:bg-orange-50">
                    🚪 Fazer Logout
                  </Button>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="p-6 bg-gradient-to-r from-purple-50 to-purple-100 rounded-2xl border border-purple-200">
                  ...
                  <Button onClick={() => navigate('/dashboard')} variant="secondary" className="w-full border-purple-300 text-purple-700 hover:bg-purple-50">
                    📈 Ver Dashboard
                  </Button>
                </div>
              </div>
