...
const Dashboard = () => {
    ...
    return (<div className="flex h-screen bg-elegant-gradient">
      ...
      <div className={`bg-white shadow-soft transition-all duration-300 ${sidebarOpen ? 'w-64' : 'w-20'} flex flex-col`}>
        <div className="p-6 border-b border-primary-100">
          <div className="flex items-center">
            ...
            {sidebarOpen && (<div className="ml-4">
          ...
          <button onClick={() => setSidebarOpen(!sidebarOpen)} className={`mt-6 p-3 rounded-2xl bg-primary-50 hover:bg-primary-100 transition-all duration-200 text-primary-600 ${!sidebarOpen ? 'mx-auto' : ''}`}>
        ...
        <nav className="flex-1 p-6">
          <ul className="space-y-3">
            <li>
              <button onClick={() => navigate('/aplicar-cilios')} className={`sidebar-item-active w-full ${!sidebarOpen ? 'justify-center' : ''}`}>
            ...
            <li>
              <button onClick={() => navigate('/minhas-imagens')} className={`sidebar-item w-full ${!sidebarOpen ? 'justify-center' : ''}`}>
            ...
            <li>
              <button onClick={() => navigate('/clientes')} className={`sidebar-item w-full ${!sidebarOpen ? 'justify-center' : ''}`}>
                <div className="flex items-center justify-center w-8 h-8 rounded-xl">
                  <span className="text-lg">👥</span>
                </div>
            ...
            <li>
              <button onClick={() => navigate('/configuracoes')} className={`sidebar-item w-full ${!sidebarOpen ? 'justify-center' : ''}`}>
                <div className="flex items-center justify-center w-8 h-8 rounded-xl">
                  <span className="text-lg">⚙️</span>
                </div>
            ...
            {isAdmin && (<>
                ...
                <li>
                  <button onClick={() => navigate('/admin/cupons')} className={`sidebar-item w-full ${!sidebarOpen ? 'justify-center' : ''}`}>
                    <div className="flex items-center justify-center w-8 h-8 rounded-xl">
                      <span className="text-lg">🎫</span>
                    </div>
                ...
                <li>
                  <button onClick={() => navigate('/admin/relatorio-cupons')} className={`sidebar-item w-full ${!sidebarOpen ? 'justify-center' : ''}`}>
                    <div className="flex items-center justify-center w-8 h-8 rounded-xl">
                      <span className="text-lg">📊</span>
                    </div>
                ...
                <li>
                  <button onClick={() => navigate('/admin/emails')} className={`sidebar-item w-full ${!sidebarOpen ? 'justify-center' : ''}`}>
                    <div className="flex items-center justify-center w-8 h-8 rounded-xl">
                      <span className="text-lg">📧</span>
                    </div>
                ...
                <li>
                  <button onClick={() => navigate('/admin/hotmart')} className={`sidebar-item w-full ${!sidebarOpen ? 'justify-center' : ''}`}>
                    <div className="flex items-center justify-center w-8 h-8 rounded-xl">
                      <span className="text-lg">🔗</span>
                    </div>
        ...
        <div className="p-6 border-t border-primary-100">
          <button onClick={handleLogout} className={`w-full flex items-center p-3 rounded-2xl text-red-500 hover:bg-red-50 hover:text-red-600 transition-all duration-200 font-medium ${!sidebarOpen ? 'justify-center' : ''}`}>
            <div className="flex items-center justify-center w-8 h-8 rounded-xl">
              <span className="text-lg">🚪</span>
            </div>
      ...
      <div className="flex-1 p-8 overflow-y-auto">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-10">
            ...
            <div className="card-interactive group" onClick={() => navigate('/aplicar-cilios')}>
            ...
            <div className="card-interactive group" onClick={() => navigate('/minhas-imagens')}>
              <div className="text-center">
                ...
                <div className="bg-primary-50 rounded-2xl py-3 px-4">
                  <div className="text-3xl font-bold text-primary-600">
                    {loading ? (<div className="animate-pulse">...</div>) : (totalImagens)}
                  </div>
            ...
            <div className="card-interactive group" onClick={() => navigate('/clientes')}>
              <div className="text-center">
                ...
                <div className="bg-secondary-50 rounded-2xl py-3 px-4">
                  <div className="text-3xl font-bold text-secondary-600">
                    {loading ? (<div className="animate-pulse">...</div>) : (totalClientes)}
                  </div>
          ...
          <div className="card">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <button onClick={() => navigate('/aplicar-cilios')} className="btn-primary gradient" style={{ background: 'linear-gradient(135deg, #ec4899 0%, #a855f7 100%)' }}>
                ✨ Nova Visualização
              </button>
              <button onClick={() => navigate('/minhas-imagens')} className="btn-secondary">
                📁 Gerenciar Imagens
              </button>
