    ...
    try {
        ...
        switch (type) {
            case 'credentials':
                ...
                success = await EmailService.sendCredentialsEmail(data.email, data.userName, data.password, data.loginUrl || 'https://ciliosclick.com/login');
            ...
            case 'welcome':
                ...
                success = await EmailService.sendWelcomeEmail(data.userEmail, data.userName, data.loginUrl || 'https://ciliosclick.com/login', data.cupomCode, data.parceiraName);
            ...
            case 'parceira':
                ...
                success = await EmailService.sendParceiraNotification(data.parceiraEmail, data.parceiraName, data.clientName, data.clientEmail, data.cupomCode, data.commissionAmount, data.purchaseValue);
