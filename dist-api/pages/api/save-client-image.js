...
import { withErrorHandling, validateAuth, validateMethod, handleApiError } from './middleware/validation';
...
async function saveClientImage(userId, imageData) {
    try {
        const novaImagem = {
            user_id: userId,
            ...imageData
...
const saveClientImageHandler = async (req, res) => {
    try {
