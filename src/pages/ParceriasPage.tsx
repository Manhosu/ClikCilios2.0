    ...
    <div className="min-h-screen bg-gradient-to-br from-rose-50 via-white to-purple-50">
      ...
      <header className="bg-white/80 backdrop-blur-sm shadow-elegant">
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex justify-between items-center">
            ...
            <Link 
              to="/login"
              className="bg-gradient-to-r from-primary-500 to-secondary-500 hover:from-primary-600 hover:to-secondary-600 text-white px-6 py-3 rounded-2xl transition-all transform hover:scale-105 shadow-elegant font-medium"
            >
              ✨ Fazer Login
            </Link>
          </div>
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <a 
            href="#formulario"
            className="bg-gradient-to-r from-primary-500 to-secondary-500 hover:from-primary-600 hover:to-secondary-600 text-white px-10 py-4 rounded-2xl text-lg font-semibold transition-all transform hover:scale-105 shadow-elegant inline-block"
          >
            Quero ser Parceira! 🎉
          </a>
        </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={4}
                  className="w-full p-4 border border-gray-200 rounded-2xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-all"
                  placeholder="Ex: Sou lashista há 3 anos, tenho 5k seguidores no Instagram, atendo 50 clientes/mês..."
                />
              </div>

              <button
                type="submit"
                className="w-full bg-gradient-to-r from-primary-500 to-secondary-500 hover:from-primary-600 hover:to-secondary-600 text-white py-4 rounded-2xl text-lg font-semibold transition-all transform hover:scale-105 shadow-elegant"
              >
